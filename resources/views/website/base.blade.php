...
<head>
    ...
    <title>Portfolio | Valerius Iman</title>
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/icon" href="{{asset('assets/assets/images/favicon.ico')}}"/>
    <!-- Font Awesome -->
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="mu-featured-area">
                    <h1>Valerius Iman Supriyatno</h1>
                    ...
                    <div class="mu-featured-content">
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Facere ipsa necessitatibus
                            voluptate. Dolores sed neque, accusantium iusto inventore harum quibusdam, aspernatur, ullam
                            vero ea eos ipsam tenetur dolore qui voluptatibus!</p>
                ...
                <div class="col-md-12">
                    <div class="mu-about-area">
                        ...
                        <div class="mu-about-header">
                            ...
                            <p>My name is Kevin Pitter. I am professional <strong>Web Designer</strong> and <strong>Web
                                    Developer</strong>. Lorem Ipsum is simply dummy text of the printing and typesetting
                        ...
                        <div class="mu-about-content">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mu-about-content-left">
                                        <img class="mu-profile-img" src="{{asset('img/profil.jpg')}}"
                                             alt="Profile Image">
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mu-social-media personal-information">
                                        <h3>Personal Information</h3>
                                        <ul>
                                            <li><label>
                                                    <div style="width: 80px;">Name</div>
                                                </label>: Valerius Iman Supriyatno
                                            </li>
                                            <li><label>
                                            ...
                                            <li><label>
                                                ...
                                                </label>: 0813 6422 6987
                                            </li>
                                            <li><label>
                                                    <div style="width: 80px;">Email</div>
                                                </label>: valeriusimansupriyatno@gmail.com
                                            </li>
                                            <li><label>
                                                    <div style="width: 80px;">Address</div>
                                                </label>: Jl. Menur, Cupuwatu 2, Purwomartani, Kalasan, Sleman, D I
                                                Yogyakarta
                                            </li>
                                        </ul>
                                    </div>
                    ...
                    <div class="mu-portfolio-area">
                        ...
                        <div class="mu-portfolio-content">
                            <div class="filtr-container">
                                ...
                                <div class="col-md-4" style="padding-bottom: 3rem;">
                                    <div class="card">
                                        <img src="{{asset('img/personalia.jpg')}}" class="card-img-top"
                                             alt="personalia">
                                        <div class="card-body">
                                            <p class="card-text">Some quick example text to build on the card title and
                                                make up the bulk of
                                ...
                                <div class="col-md-4" style="padding-bottom: 3rem;">
                                    <div class="card">
                                        <img src="{{asset('img/perpustakaan.jpg')}}" class="card-img-top"
                                             alt="perpustakaan">
                                        <div class="card-body">
                                            <p class="card-text">Some quick example text to build on the card title and
                                                make up the bulk of
                                        ...
                                        <div class="row">
                                            <div class="col-sm-4">
                                                <div class="mu-contact-top-single">
                                                    ...
                                                    <p>Jl. Menur, Cupuwatu 2, Purwomartani, Kalasan, Sleman, D I
                                                        Yogyakarta</p>
                                                </div>
                                            </div>
                                            <div class="col-sm-4">
                                            ...
                                            <div class="col-sm-4">
                                                <div class="mu-contact-top-single">
                                                    ...
                                                    <p>valeriusimansupriyatno@gmail.com</p>
                                                </div>
                                            </div>
...
<footer id="mu-footer" role="contentinfo">
    <div class="container">
        <div class="mu-footer-area">
            <p class="mu-copy-right">&copy; Copyright <a rel="nofollow" href="#">Valerius Iman</a>. All
                right reserved.</p>
        </div>
    </div>
...
<!-- Slick slider -->
<script type="text/javascript" src="{{asset('assets/assets/js/slick.min.js')}}"></script>
<!-- Filterable Gallery js -->
<script type="text/javascript" src="{{asset('assets/assets/js/jquery.filterizr.min.js')}}"></script>
<!-- Gallery Lightbox -->
<script type="text/javascript" src="{{asset('assets/assets/js/jquery.magnific-popup.min.js')}}"></script>
<!-- Ajax contact form  -->
<script type="text/javascript" src="{{asset('assets/assets/js/app.js')}}"></script>
<!-- Featured Slider -->
<script type="text/javascript" src="{{asset('assets/assets/js/typed.min.js')}}"></script>
<!-- On scroll JS  -->
<script src="{{asset('assets/assets/js/jquery.appear.js')}}"></script>
<!-- Progress Bar -->
<script type="text/javascript" src="{{asset('assets/assets/js/jquery.lineProgressbar.js')}}"></script>
